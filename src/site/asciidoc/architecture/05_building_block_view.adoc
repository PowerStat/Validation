...
package de.powerstat.ddd.values
{
  ...
  class BuildingName
  class BuildingNr
  class CalendarSystems
  class City
  class CivilStatus
  class CommunicatioonChannel
  class Country
  class Currency
  class Day
  class Days
  ...
  class Hours
  class IBAN
  class InternationalPhoneAreaCode
  class IPV4Address
  class IPV4Mask
  class IPV6Address
  class IPV6Mask
...
package de.powerstat.ddd.values.impl
{
  ...
  class IISBN13Publisher
  class ISBN13Publisher0
  class ISBN13Publisher1
  class ISBN13Publisher3
}
...
java.net <-- de.powerstat.ddd
java.net <-- de.powerstat.ddd.values
java.util <-- de.powerstat.ddd
java.util <-- de.powerstat.ddd.comparators
java.util <-- de.powerstat.ddd.entities
java.util <-- de.powerstat.ddd.entities.impl
java.util <-- de.powerstat.ddd.values.impl
java.util <-- de.powerstat.ddd.values.strategies
java.util <-- de.powerstat.ddd.values
java.util <-- de.powerstat.ddd.generated
java.time <-- de.powerstat.ddd.entities
java.time <-- de.powerstat.ddd.entities.impl
java.io <-- de.powerstat.ddd.comparators
java.math <-- de.powerstat.ddd.values
de.powerstat.ddd.generated <-- de.powerstat.ddd
de.powerstat.ddd.generated <-- de.powerstat.ddd.values
de.powerstat.ddd.entities.impl <-- de.powerstat.ddd.entities
de.powerstat.ddd.values <-- de.powerstat.ddd.entities
de.powerstat.ddd.values <-- de.powerstat.ddd.values.impl
de.powerstat.ddd.values <-- de.powerstat.ddd.values.strategies
de.powerstat.ddd.values.impl <-- de.powerstat.ddd.values
de.powerstat.ddd.values.strategies <-- de.powerstat.ddd.values
de.powerstat.ddd.values.containers <-- de.powerstat.ddd.values
de.powerstat.ddd.values.containers <-- de.powerstat.ddd.values.impl
de.powerstat.ddd.values.containers <-- de.powerstat.ddd.values.strategies
....
