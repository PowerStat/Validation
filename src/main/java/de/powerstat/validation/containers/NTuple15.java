...
public final class NTuple15<T1 extends Comparable<T1>, T2 extends Comparable<T2>, T3 extends Comparable<T3>, T4 extends Comparable<T4>, T5 extends Comparable<T5>, T6 extends Comparable<T6>, T7 extends Comparable<T7>, T8 extends Comparable<T8>, T9 extends Comparable<T9>, T10 extends Comparable<T10>, T11 extends Comparable<T11>, T12 extends Comparable<T12>, T13 extends Comparable<T13>, T14 extends Comparable<T14>, T15 extends Comparable<T15>> implements Comparable<NTuple15<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>>
 {
  ...
  /**
   * Returns the third value of this NTuple15 as a T3.
   *
  ...
  /**
   * Returns the fourth value of this NTuple15 as a T4.
   *
  ...
  /**
   * Returns the fifth value of this NTuple15 as a T5.
   *
  ...
  /**
   * Returns the sith value of this NTuple15 as a T6.
   *
  ...
  /**
   * Returns the seventh value of this NTuple15 as a T7.
   *
  ...
  /**
   * Returns the eighth value of this NTuple15 as a T8.
   *
  ...
  /**
   * Returns the nineth value of this NTuple15 as a T9.
   *
  ...
  /**
   * Returns the tenth value of this NTuple15 as a T10.
   *
  ...
  /**
   * Returns the eleventh value of this NTuple15 as a T11.
   *
  ...
  /**
   * Returns the twelfth value of this NTuple15 as a T12.
   *
  ...
  /**
   * Returns the thirdtenth value of this NTuple15 as a T13.
   *
  ...
  /**
   * Returns the fourtenth value of this NTuple15 as a T14.
   *
  ...
  /**
   * Returns the fifthenth value of this NTuple15 as a T15.
   *
