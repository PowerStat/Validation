...
import de.powerstat.ddd.values.geo.Address;
import de.powerstat.ddd.values.geo.BFPONumber;
import de.powerstat.ddd.values.geo.Block;
import de.powerstat.ddd.values.geo.BuildingName;
...
import de.powerstat.ddd.values.geo.District;
import de.powerstat.ddd.values.geo.Lines;
import de.powerstat.ddd.values.geo.Neighbourhood;
import de.powerstat.ddd.values.geo.PoBoxNumber;
import de.powerstat.ddd.values.geo.PostalCode;
import de.powerstat.ddd.values.geo.Province;
import de.powerstat.ddd.values.geo.Street;
import de.powerstat.ddd.values.geo.SubBuilding;
import de.powerstat.ddd.values.social.Department;
