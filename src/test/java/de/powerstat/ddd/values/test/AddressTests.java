...
import de.powerstat.ddd.values.Address;
import de.powerstat.ddd.values.BFPONumber;
import de.powerstat.ddd.values.Block;
import de.powerstat.ddd.values.BuildingName;
import de.powerstat.ddd.values.BuildingNr;
import de.powerstat.ddd.values.City;
import de.powerstat.ddd.values.Country;
import de.powerstat.ddd.values.Department;
import de.powerstat.ddd.values.District;
import de.powerstat.ddd.values.Lines;
import de.powerstat.ddd.values.Neighbourhood;
import de.powerstat.ddd.values.PoBoxNumber;
import de.powerstat.ddd.values.PostalCode;
import de.powerstat.ddd.values.Province;
import de.powerstat.ddd.values.Street;
import de.powerstat.ddd.values.SubBuilding;
